package dev.woori.WooriServer.oauth;

import dev.woori.WooriServer.oauth.dto.TokenResponse;
import dev.woori.WooriServer.oauth.dto.UserInfoResponse;
import dev.woori.WooriServer.oauth.feign.AuthServerFeign;
import dev.woori.WooriServer.oauth.feign.ResourceServerFeign;
...
public class FeignProvider {
    ...
    public UserInfoResponse getUserInfoFromAS(final String accessToken) {
        return authServerFeign.getUserInfo(accessToken);
    }
    public String getGreetingFromRS(final String bearerToken) {
